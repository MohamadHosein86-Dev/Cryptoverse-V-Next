...
export default function FormContact() {
  return (
    <form dir="ltr" className=" basis-1/2 ">
      ...
      <input placeholder="name *" className=" text-gray1 font-semibold pb-6 pr-8 mt-8 w-full bg-none border-b-1 outline-none " type="text" />
      <label className=" flex justify-end w-full -mb-14 mt-8  " htmlFor="">
        <MdEmail size={21} />
      </label>
      <input placeholder="email *" className=" text-gray1 font-semibold pb-6 pr-8 mt-8 w-full bg-none border-b-1 outline-none " type="text" />
      <label className=" flex justify-end w-full -mb-14 mt-8 " htmlFor="">
        <FaEdit size={21} />
      </label>
      <input placeholder="send your message" className=" text-gray1 font-semibold pb-36 pr-8 mt-8 w-full bg-none border-b-1 outline-none " type="text" />
