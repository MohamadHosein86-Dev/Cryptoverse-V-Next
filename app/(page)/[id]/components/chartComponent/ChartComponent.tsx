  ...
  if (!chartData || error)
    return (
      <div className=" bg-black  w-full  md:w-1/2 flex flex-col gap-8 items-center  ">
        <div className=" mx-4 px-4  py-8 rounded-2xl  sm:mx-auto my-8 border border-gray-300Border font-semibold cursor-pointer  sm:w-3/5  text-red-500 text-center text-sm sm:text-lg">
          <p>{error?.message} - Error while loading currencies. Please try again later</p>
        </div>
      </div>
    );
  return (
    <div className=" bg-surface-900 rounded-xl p-4 w-full">
