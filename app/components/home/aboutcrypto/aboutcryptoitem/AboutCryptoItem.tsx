  ...
  return (
    ...
    >
      <div className="max-sm:w-full mx-auto text-center sm:text-left text-white md3:w-1/2 flex flex-col gap-2 md:order-1">
        <h3 className=" text-xl mb-4 sm:mb-0 sm:text-2xl font-bold">{titel}</h3>
        <p className="text-sm leading-7 mx-auto sm:mx-0 sm:text-normal w-10/12 text-gray-300 text-justify">{description}</p>
      </div>
